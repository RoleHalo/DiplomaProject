<template>
	<div v-if="isAuth(['ROOT', 'DEPT:SELECT'])">
		...
		<!-- 用户勾选或者取消勾选记录的时候，都会触发@selection-change事件 -->
		<el-table
			:data="dataList"
			border
		...
		>
			...
			<el-table-column prop="deptName" header-align="center" align="center" label="班级名称" min-width="170"/>
			...
			<el-table-column header-align="center" align="center" label="学生数量" min-width="140" >
				<template #default="scope">
...
export default {
	...
	data: function() {
		return {
			...
			dataRule: {
				deptName: [
					{ required: false, pattern: '^[a-zA-Z0-9\u4e00-\u9fa5]{1,10}$', message: '班级名称格式错误' }
				]
			}
		};
	},
