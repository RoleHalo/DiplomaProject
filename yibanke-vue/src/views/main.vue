		...
		<nav class="site-navbar" :class="'site-navbar--' + navbarLayoutType">
			<div class="site-navbar__header">
				<h1 class="site-navbar__brand">
					<a class="site-navbar__brand-lg">YBK教学辅助系统</a>
					<a class="site-navbar__brand-mini">YBK</a>
				</h1>
			</div>
		...
		<aside class="site-sidebar site-sidebar--dark">
			<div class="site-sidebar__inner">
				...
				>
					...
					<el-submenu
						index="信息管理"
						v-if="isAuth(['ROOT','TEACHER:SELECT','DEPT:SELECT','STUDENT:SELECT'])"
					...
					>
						...
						<el-menu-item
							index="student"
							v-if="isAuth(['ROOT', 'STUDENT:SELECT'])"
						...
						<el-menu-item
							index="student"
							v-if="isAuth(['ROOT', 'TEACHER:SELECT'])"
