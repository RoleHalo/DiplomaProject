<template>
	<div v-if="isAuth(['ROOT', 'TEACHER:SELECT'])">
		<el-form :inline="true" :model="dataForm" :rules="dataRule" ref="dataForm">
			...
			<el-form-item>
				...
				<el-button
					size="medium"
					type="primary"
					:disabled="!isAuth(['ROOT', 'TEACHER:INSERT'])"
					@click="addHandle()"
				>
					新增
				</el-button>
			...
			<el-table-column header-align="center" align="center" width="150" label="操作">
				<template #default="scope">
					...
					<el-button
						type="text"
						size="medium"
						v-if="isAuth(['ROOT', 'TEACHER:UPDATE'])"
...
export default {
	...
	methods: {
		...
		loadDataList: function() {
		    ...
		    that.$http('user/searchTeacherByPage', 'POST', data, true, function(resp) {
		        let page = resp.page;
		        let list = page.list;
		        for (let one of list) {
		            if (one.status == 1) {
