...
app.use(VueNativeSock,"ws://192.168.123.143:8091/yibanke-api/socket",{ 
    "format": "json"
});
...
app.config.globalProperties.getPdf = function() {
	var title = this.dept+'_'+ this.name +'_'+ this.htmlTitle //PDF标题
...
//后端项目的URL根路径   
let baseUrl = "http://127.0.0.1:8091/yibanke-api/"
